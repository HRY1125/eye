...
<body>
        ...
        <form action="<%=request.getContextPath() %>/adminNews/addNews" method="post" class="layui-form">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" class="layui-input" name="newsTitle" placeholder="请输入新闻标题" required>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">新闻内容：</label>
                <div class="layui-input-inline">
                    <textarea class="layui-textarea" name="newsContent" placeholder="开始撰写..." required></textarea>
                </div>
            </div>
            <div class="layui-form-item">
    ...
    <div id="editForm" hidden="hidden" style="padding: 20px">
        <form action="<%=request.getContextPath() %>/adminNews/updateNews" method="post" class="layui-form">
            ...
            <div class="layui-form-item">
                <label class="layui-form-label">新闻标题：</label>
                <div class="layui-input-inline">
                    <input type="text" class="layui-input" name="newsTitle" id="newsTitle" placeholder="请输入新闻标题" required>
                </div>
            </div>
            <div class="layui-form-item">
    ...
    <div id="textAreaForm" hidden="hidden" style="padding: 20px">
        <form action="<%=request.getContextPath() %>/adminNews/textAreaUpdate" method="post" class="layui-form">
            ...
            <div class="layui-form-item">
                <textarea id="textAreaNewsContent" class="layui-textarea" name="newsContent" placeholder="开始撰写..." required style="height: 200px"></textarea>
            </div>
            <div class="layui-form-item">
        ...
        layui.use(['layer', 'table', 'form'], function () {
            ...
            table.render({
                ...
                cols : [ [
                    ...
                    {field : 'newsTitle',title : '新闻标题',align : 'center',width : 210},
